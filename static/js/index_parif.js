...
Promise.all([
  fetch("http://127.0.0.1:8000/parif/api/parcelles_parif/v1/"),
...
data1.forEach(({id, type, proprietaire, code_parcelle, cooperative, section, designation, latitude, longitude, localite, superficie, culture, culture_associee  }) => {
    parcelles.addLayer(
        ...
        `
          <table class="table table-striped table-bordered">
            ...
            <tbody style="align-items: center">            
                <tr>
                    <th scope="col"><b>TYPE PARCELLE:</b></th>
                    <td class="text-uppercase"><strong>${type}</strong></td>                    
                </tr>
                <tr>
                    <th scope="col"><b>LOCALITE :</b></th>
                    <td class="text-uppercase"><strong>${localite}</strong></td>                    
                </tr>
                <tr>
                    <th scope="col"><b>COOPERATIVE :</b></th>
                    <td class="text-uppercase"><strong>${cooperative}</strong></td>                    
                </tr>
                <tr>
                    <th scope="col"><b>PRODUCTEUR :</b></th>
                    <td class="text-uppercase"><strong>${proprietaire}</strong></td>                    
                </tr>
                <tr>
                    <th scope="col"><b>CODE PARCELLE :</b></th>
                    <td class="text-uppercase"><strong>${code_parcelle}</strong></td>                    
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="col"><b>CULTURE ASSOCIEE :</b></th>
                    <td class="text-uppercase">${culture_associee}</td>                    
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-uppercase text-center">
                        <a style="color: #fff; font-weight: bold" class="btn btn-success btn-sm" href="#" role="button"><i class="glyphicon glyphicon-tree-deciduous"></i> Afficher</a>
                    </td>
                </tr>
            </tbody>
          </table>    
